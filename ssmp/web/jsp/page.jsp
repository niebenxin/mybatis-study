...
<div style="position: absolute; top: 350px;left: 660px">
    当前页${page.current}
    <a href="${pageContext.request.contextPath}/student/queryAll">首页</a>
    <a href="${pageContext.request.contextPath}/student/queryAll?pageIndex=${page.current-1}" ${page.current-1<1?"hidden":""}>上一页</a>
    <a href="${pageContext.request.contextPath}/student/queryAll?pageIndex=${page.current+1}" ${page.current>=end?"hidden":""}>下一页</a>
    <a href="${pageContext.request.contextPath}/student/queryAll?pageIndex=${end}">尾页</a>
    总条数${page.total}
    共${end}页
</div>
</body>
